...
The product that we came up with is a website\cite{TOEICTrainer}. In order to complete the pre-requisits that we wanted, we thought a website could reach everyone at school, and beyond.
